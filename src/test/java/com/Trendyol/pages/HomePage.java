...
public class HomePage {
    ...
    //public static final By randomProductNameonProductDetailPage = By.xpath("(//h1[@class='pr-new-br']/*)[1]");
    //public static final By addToBasketButton = By.xpath("//button[@class='add-to-basket']");
    //public static final By addToBasketButtonTextSuccess = By.xpath("(//div[text()='Sepete Eklendi']");
